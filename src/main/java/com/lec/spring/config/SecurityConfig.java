...
@Configuration  // 이 파일이 스프링 환경 설정 파일임을 의미하는 애너테이션
@EnableWebSecurity  // 모든 url이 스프링 시큐리티의 제어를 받기위해 사용, 스프링 시큐리티 활성화 역할
...
//                        .logoutSuccessUrl("/home")  // 로그아웃 성공후 redirect url
                        ...
                        .invalidateHttpSession(false)   // session invalidate 수행안함 // 세션을 다 날리는 것을 일단은 보류하는것
